...
public interface RedisSession {
     ...
     * @throws RedisException
     */
    long decrby(String key,long value)throws RedisException;
     ...
     * @throws RedisException
     */
    long incrby(String key,long value)throws RedisException;
     ...
     * @param msg
     */
    void publish(String chanel, Object msg);
     ...
     * @param msgJson
     */
    void publish(String chanel, String msgJson);
