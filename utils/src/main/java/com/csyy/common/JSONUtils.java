...
//	public static final GsonBuilder builder = new GsonBuilder();
	...
	public static String toJsonWithStringNull2Empty(Object target) {
		return toJson(target, null, true, null, DEFAULT_DATE_TIME_PATTERN, false,
				true);
	}
	...
	public static String toJson(Object target, Double version) {
		return toJson(target, null, false, version, DEFAULT_DATE_TIME_PATTERN,
				false, false);
	}
	...
	public static String toJson(Object target, boolean nullAble) {
		return toJson(target, null, nullAble, null, DEFAULT_DATE_TIME_PATTERN,
				false, false);
	}
	 ...
	 */
	public static String toJson(Object target, Type targetType) {
		return toJson(target, targetType, false, null, DEFAULT_DATE_TIME_PATTERN,
				false, false);
	}
	...
	public static String toJson(Object target, Type targetType, Double version) {
		return toJson(target, targetType, false, version, DEFAULT_DATE_TIME_PATTERN,
				false, false);
	}
...
class DoubleImpl implements JsonSerializer<Double> {
	...
	public JsonElement serialize(Double src, Type typeOfSrc,
		...
		if (src == src.longValue()) {
			return new JsonPrimitive(new BigDecimal(src.longValue()));
		}
