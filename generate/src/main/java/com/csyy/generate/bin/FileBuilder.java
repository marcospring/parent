...
public class FileBuilder {
    //java文件相对目录
    public static String coommonJavaPath = "/src/main/java/com/malt/";
    //资源文件相对目录
    ...
    private void initFilePath(){
        ...
        if(!StringDefaultValue.isEmpty(config.getSystemName())){
            ...
            //sqlmap文件路径
            filePathMap.put(SQLMAP_FILE_PATH, config.getWorkspacesPath() + config.getSystemName() + coommonResourcesPath + "sqlmap/po/" + config.getPoName() + Constants.FileType.XML_SUFFIX);
            //PO文件路径
